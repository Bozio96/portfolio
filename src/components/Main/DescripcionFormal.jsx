...
export default function DescripcionFormal() {
  return (
      <Container sx={{ backgroundColor: "rgb(17, 17, 17)", py: 5 }}>
        <Typography
          variant="h2"
        ...
        <Typography
          ...
          sx={{ textAlign: "center" }}
        >
          Me llamo Rodrigo Bozio, tengo 28 años. Actualmente estudio Ingeniería
          en Sistemas hasta el tercer (3) año inclusive.
        </Typography>
        <Typography
          variant="body1"
          color="rgb(255,255,255)"
        ...
        <Box>
          ...
          <Box
           display="flex" flexWrap="wrap" justifyContent="center" gap={2} sx={{my: 3}}
          >
            {/* NodeJs */}
            <Box
              display="flex"
        ...
        <Box>
          ...
          <Box display="flex" flexWrap="wrap" justifyContent="center" gap={2} sx={{my: 3}}>
            {/* Angular */}
            <Box
              display="flex"
              alignItems="center"
